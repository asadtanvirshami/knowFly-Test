...
//Icons import from public folder
...
import insta from '../../public/images/icons/i.png'
import yt from '../../public/images/icons/y.png'
import fb from '../../public/images/icons/f.png'
import tw from '../../public/images/icons/t.png'

const Header = () => {
    //conditional states for navigation header
            ...
            <nav className="2xl:container 2xl:mx-auto sm:py-6 sm:px-7 py-5 px-4">
                ...
                <div className="flex justify-between ">
                    <div className="hidden sm:flex flex-row items-center space-x-6">
                      ...
                      <Image src={call} width={25} height={25}/>
                      <h1 className="font-bold">+22 319 921 967</h1>
                      </div>
                    </div>
                    <div className=" flex space-x-3 items-center">
                        ...
                        <h1 className=" font-normal text-2xl leading-6 text-gray-800">EcomStore</h1>
                    </div>
                    <div className="hidden sm:flex flex-row space-x-4">
                    <div className="hidden sm:flex flex-row space-x-4 mt-5">
                    <Image src={insta} width={30} height={25}/>
                    <Image src={yt} width={30} height={25}/>
                    <Image src={fb} width={30} height={25}/>
                    <Image src={tw} width={30} height={25}/>
                    </div>
                    </div>
                    {/* Burger Icon */}
                ...
                <div className="flex justify-between ">
                    <div className="hidden sm:flex flex-row items-center space-x-6">
                      <ul className="flex inline-block">
                        <li className="hover:text-orange-500 transition-all duration-300 ease-in-out mr-2 font-semibold cursor-pointer">Home</li>
                        <li className="hover:text-orange-500 transition-all duration-300 ease-in-out mr-2 font-semibold cursor-pointer">About</li>
                        <li className="hover:text-orange-500 transition-all duration-300 ease-in-out mr-2 font-semibold cursor-pointer">FAQs</li>
                        <li className="hover:text-orange-500 transition-all duration-300 ease-in-out mr-2 font-semibold cursor-pointer">Terms</li>
                      </ul>
                    </div>
                    <div className=" flex space-x-3 items-center">
                    ...
                    <div className="hidden sm:flex flex-row space-x-4 mt-5">
                    <Image src={heart} width={25} height={25}/>
                    <Image src={cart} width={25} height={25}/>
                    <Image src={admin} width={25} height={25}/>
                    </div>
                </div>
